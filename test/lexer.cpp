...
int main()
{
    ...
    {
        auto const lexer = bp::lexer<my_tokens>() |
                           bp::token_spec<"foo">(my_tokens::foo) |
                           bp::token_spec<"bar">(my_tokens::bar) |
                           bp::token_spec<"baz">(my_tokens::baz);
    }
    {
        auto const lexer = bp::lexer<my_tokens>() | bp::token_chars<'='>();
    }
    {
        auto const lexer = bp::lexer<my_tokens>() | bp::token_chars<'='>() |
                           bp::token_spec<"foo">(my_tokens::foo) |
    ...
    {
        auto const lexer =
            bp::lexer<my_tokens>() | bp::token_spec<"foo">(my_tokens::foo) |
            bp::token_spec<"bar">(my_tokens::bar) |
